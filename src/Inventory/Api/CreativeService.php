...
use Google\AdsApi\AdManager\v202205\CreativeTemplateService;
...
class CreativeService {
	...
	function __construct() {
		$this->creativeService = AdManagerService::get(\Google\AdsApi\AdManager\v202205\CreativeService::class);
