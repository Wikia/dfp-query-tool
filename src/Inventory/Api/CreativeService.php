...
use Google\AdsApi\AdManager\v202308\CreativeTemplateService;
...
class CreativeService {
	...
	function __construct() {
		$this->creativeService = AdManagerService::get(\Google\AdsApi\AdManager\v202308\CreativeService::class);
