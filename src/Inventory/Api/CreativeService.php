...
use Google\AdsApi\AdManager\v202208\CreativeTemplateService;
...
class CreativeService {
	...
	function __construct() {
		$this->creativeService = AdManagerService::get(\Google\AdsApi\AdManager\v202208\CreativeService::class);
