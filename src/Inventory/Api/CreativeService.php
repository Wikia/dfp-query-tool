...
use Google\AdsApi\AdManager\v202002\CreativeTemplateService;
...
class CreativeService {
	...
	function __construct() {
		$this->creativeService = AdManagerService::get(\Google\AdsApi\AdManager\v202002\CreativeService::class);
