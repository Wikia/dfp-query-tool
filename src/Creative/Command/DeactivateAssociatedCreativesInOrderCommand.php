...
class DeactivateAssociatedCreativesInOrderCommand extends Command
{
	...
	{
		$this->setName('creatives:deactivate')
			->setDescription('Deactivates associated creatives in all line items in order')
			->addArgument(
				'creative-id',
	...
	protected function execute(InputInterface $input, OutputInterface $output)
	{
		...
		foreach ($lineItems as $i => $lineItem) {
			$result = $associationService->deactivate($creativeId, $lineItem->getId());
			if ($result['success']) {
